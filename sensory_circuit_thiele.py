...
original @author: Klaus Wimmer

wimmer.klaus@googlemail.com

modified by Alexander Thiele
...
def make_sensory_circuit():
    ...
    # Populations
    size_scale=1.3
    N_E = int(1600 * size_scale)                      # Total number of excitatory neurons
    N_E1 = int(0.5 * N_E)                        # Size of excitatory population E1
    N_E2 = N_E1                                  # Size of excitatory population E2
    N_I = int (400 *    1)                               # Size of inhibitory population I
    N_X = int (1000* size_scale)                                  # Size of external population X
